<template>
  <div class="max-w-40 mx-auto mr-40 relative flex flex-col justify-center items-center">
    <div class="bg-white rounded-3xl shadow-2xl p-6 fixed top-96 left-12">
      ...
      <nav class="flex flex-col text-center">
        ...
        <div>
          <div class="absolute left-0" v-if="isActive('/edashboard')">
        ...
        <div>
          <div class="absolute left-0" v-if="isActive('/epointing')">
            <svg width="10" height="30" viewBox="0 0 10 30" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0 0H5C7.76142 0 10 2.23858 10 5V25C10 27.7614 7.76142 30 5 30H0V0Z" fill="#0842A0"/>
            </svg>
          </div>
        ...
        <div>
          <div class="absolute left-0" v-if="isActive('/eplanning')">
            <svg width="10" height="30" viewBox="0 0 10 30" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0 0H5C7.76142 0 10 2.23858 10 5V25C10 27.7614 7.76142 30 5 30H0V0Z" fill="#0842A0"/>
            </svg>
          </div>
